    ...
    let lines = suggestions
        ...
        .map(|(index, command)| {
            let description = match (app.language, *command) {
                ...
                (UiLanguage::ZhCn, "/new") => "开始新的空白会话",
                (UiLanguage::ZhCn, "/permission") => "设置本次运行的修改审批",
                ...
                (UiLanguage::En, "/new") => "Start a new blank session",
                (UiLanguage::En, "/permission") => "Set mutation approval for this run",
